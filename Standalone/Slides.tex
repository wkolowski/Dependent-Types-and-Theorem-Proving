...
\begin{itemize}
	...
	\item See the file \texttt{Standalone/Code/Prerequisites.fst}.
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item The code snippet can be found in \m{Standalone/Code/Universe.fst}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item See the code snippet \m{Standalone/Code/DependentFunctions.fst}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item See the code snippet \m{Standalone/Code/DependentRecords.fst}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item See the code snippet \m{Standalone/Code/InductiveFamilies.fst}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item It lso means we need to write a lot of boilerplate - for example, we need to define \m{map} separately for lists and vectors.
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item In F* syntax: \m{x \: a\{p x\}} where \m{p \: a -> bool} - the types of elements of type \m{a} for which \m{p x} is \m{true}.
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item See the code snippet \m{Standalone/Code/Refinements.fst}
\end{itemize}
\end{frame}
