...
% Introduce pi by analogy with ordinary function type.
...
% different if-branches. Maybe compare this to dynamic typing.
...
% Introduce sigma by analogy with ordinary products.
