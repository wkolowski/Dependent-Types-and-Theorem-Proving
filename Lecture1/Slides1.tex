...
\begin{itemize}
	...
	\item So, we will have a little quiz to check if you get it right. Are the below language constructors first-class in F\# or not?
	\item Functions?
...
\begin{itemize}
	\item I prefer to think about it this way.
	...
	\item In C, that's not the case and this is why functions are not first-class  
\end{itemize}
\end{frame}

\begin{frame}{Some helpers}
\begin{itemize}
	\item I you don't like the above characterization, you might use some other ones:
	\item 
\end{itemize}
\end{frame}
