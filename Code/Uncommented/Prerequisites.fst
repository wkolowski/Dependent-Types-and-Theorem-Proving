...
// Disjoint unions, also known as sums.
type intOrString =
    | Left of int
    | Right of string
...
// Records are syntax sugar for single-constructor disjoint unions.
type stuff2 =
...
// Inductive types (also called algebraic data types) - recursive disjoint unions.
type binaryTree =
    | Empty : binaryTree
